...
class frozenLake:
    ...
    def step(self, action):
        ...
        self.player = np.zeros(self._n_states)
        self.player[self._current_state] = 1
        return [self.holes, self.player, self.goal], self.get_reward(prev_state, action, self._current_state), \
